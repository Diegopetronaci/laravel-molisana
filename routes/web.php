...
Route::get('prodotti', function () {
    ...
    /* array_filter($data) */
    $cortissima = array_filter($data, function($dato) {
        return $dato['tipo'] == 'cortissima';
    });
    $corta = array_filter($data, function($dato) {
        return $dato['tipo'] == 'corta';
    });
    $lunga = array_filter($data, function($dato) {
        return $dato['tipo'] == 'lunga';
    });
    /* dd($cortissima, $lunga, $corta); */
    $paste = [
    ...
    return view('prodotti', compact( /* 'corta','cortissima','lunga', */'paste' ));
});
